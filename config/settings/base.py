"""
Base settings for alted project.
...
# ------------------------------------------------------------------------------
MIGRATION_MODULES = {
    'sites': 'alted.contrib.sites.migrations'
}
...
ADMINS = [
    ("""fsdevio""", 'moczydlowski.kamil@gmail.com'),
]
...
DATABASES = {
    'default': env.db('DATABASE_URL', default='postgres:///alted'),
}
...
########## CELERY
INSTALLED_APPS += ['alted.taskapp.celery']
